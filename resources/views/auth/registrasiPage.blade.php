                    ...
                    <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                        <div class="p-30 invisible" data-toggle="appear">
                            ...
                            <p class="font-italic text-white-op">
                                Copyright &copy; Haxorsprogrammingclub - Support by Pixelkreatif
                            </p>
                        </div>
                    </div>
                        ...
                        <div class="content content-full">
                            ...
                            <div class="px-30 py-10">
                                <div class="teksTengah">
                                    <img src="https://s3.jagoanstorage.com/aditia-storage/asset/logo/logo_club.png" class="wd200">
                                    <div>
                            ...
                            <div class="js-validation-signin px-30" id="divForm">
                                <div class="form-group row">
                                    <div class="col-12">
                                        <div class="form-material floating">
                                            ...
                                            <label for="login-password">Fullname</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group">
                                    <a class="btn btn-sm btn-hero btn-alt-primary" onclick="SignUpAtc()">
                                        <i class="si si-login mr-10"></i> Sign Up
                                    </a>
                                    <div class="mt-30">
                                        <a class="link-effect text-muted mr-10 mb-5 d-inline-block" href="{{ url('/') }}">
