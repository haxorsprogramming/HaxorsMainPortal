                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="https://s3.jagoanstorage.com/aditia-storage/asset/logo/logo_club.png" alt="" height="80">
                            </span>
                            <span class="logo-lg">
                                <img src="https://s3.jagoanstorage.com/aditia-storage/asset/logo/logo_club.png" alt="" height="80">
                            </span>
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="https://s3.jagoanstorage.com/aditia-storage/asset/logo/logo_club.png" alt="" height="52">
                            </span>
                            <span class="logo-lg">
                                <img src="https://s3.jagoanstorage.com/aditia-storage/asset/logo/logo_club.png" alt="" height="49">
                            </span>
                        </a>
                    </div>
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-layout">
                                    <a href="javascript:void(0)" onclick="renderPage('registrasi/token/list', 'Token Registrasi Member')" class="dropdown-item">Token Registrasi</a>
